...
<nav class="navbar navbar-inverse navbar-fixed-top " role="navigation">
				...
				<div class="collapse navbar-collapse " id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right ">
						...
						<li><a href="examDetails.jsp" >Exam Details</a></li>
                                                <li><a href="LogicQuestionAdd.jsp" >Logic Question</a></li>
	...
	<div class="row">
            ...
            <table class="table table-hover" >
                <thead>
                 <tr>
                     ...
                     <th class="">No. of Logic Question<br>Attended</th>
          ...
          <tr>
                     ...
                     <td><%=count%></td>
                     <td ><a  href="logicDetails.jsp?lid=<%=lid %>"  ><span class="fa fa-2x fa-eye" ></span></a></td>
                 </tr>
